...
if __name__ == "__main__":
    ...
    project_id = 3  # ID del proyecto en Label Studio, cambia esto según tu configuración

    ## Cambia esto a tu directorio de imágenes
    img_dir = "/Users/sofiamedellin/Downloads/example_airborne_birds"  # Directorio de imágenes
